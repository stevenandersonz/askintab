...
<button class="askintab-followup-q"> 1 </button>
<button class="askintab-followup-q"> 1 </button>
<button class="askintab-followup-q"> 1 </button>
<button class="askintab-followup-q"> ask yourself </button>
`
...
graph TD
  ...
  // }, 1000*20)
  setTimeout(function(){
    chrome.runtime.sendMessage({ type: "LLM_RESPONSE", payload:{name:"grok", response}});
  }, 1000*1)
}
